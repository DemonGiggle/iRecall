(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const l of i)if(l.type==="childList")for(const d of l.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&r(d)}).observe(document,{childList:!0,subtree:!0});function a(i){const l={};return i.integrity&&(l.integrity=i.integrity),i.referrerPolicy&&(l.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?l.credentials="include":i.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function r(i){if(i.ep)return;i.ep=!0;const l=a(i);fetch(i.href,l)}})();const q={violet:{bg:"#0f172a",bgStrong:"#0b1120",panel:"rgba(17, 24, 39, 0.92)",panel2:"rgba(31, 41, 55, 0.82)",border:"#374151",borderStrong:"rgba(167, 139, 250, 0.42)",primary:"#7c3aed",accent:"#a78bfa",muted:"#94a3b8",fg:"#f9fafb",ok:"#10b981",error:"#ef4444",shadow:"0 24px 80px rgba(2, 6, 23, 0.38)",colorScheme:"dark"},forest:{bg:"#071a17",bgStrong:"#041311",panel:"rgba(9, 24, 21, 0.92)",panel2:"rgba(15, 41, 35, 0.82)",border:"#29443f",borderStrong:"rgba(45, 212, 191, 0.42)",primary:"#0f766e",accent:"#2dd4bf",muted:"#9ca3af",fg:"#ecfdf5",ok:"#22c55e",error:"#ef4444",shadow:"0 24px 80px rgba(1, 10, 9, 0.38)",colorScheme:"dark"},sunset:{bg:"#1c0f0a",bgStrong:"#130905",panel:"rgba(33, 17, 12, 0.94)",panel2:"rgba(52, 28, 18, 0.82)",border:"#5c4033",borderStrong:"rgba(251, 146, 60, 0.44)",primary:"#c2410c",accent:"#fb923c",muted:"#d6b8a6",fg:"#fffbeb",ok:"#16a34a",error:"#dc2626",shadow:"0 24px 80px rgba(20, 8, 2, 0.4)",colorScheme:"dark"},ocean:{bg:"#081824",bgStrong:"#06111a",panel:"rgba(11, 25, 38, 0.92)",panel2:"rgba(18, 40, 56, 0.82)",border:"#334155",borderStrong:"rgba(56, 189, 248, 0.42)",primary:"#0369a1",accent:"#38bdf8",muted:"#94a3b8",fg:"#f8fafc",ok:"#10b981",error:"#ef4444",shadow:"0 24px 80px rgba(3, 9, 16, 0.38)",colorScheme:"dark"},paper:{bg:"#f8fafc",bgStrong:"#e2e8f0",panel:"rgba(255, 255, 255, 0.96)",panel2:"rgba(248, 250, 252, 0.94)",border:"#cbd5e1",borderStrong:"rgba(29, 78, 216, 0.28)",primary:"#1d4ed8",accent:"#0f766e",muted:"#64748b",fg:"#111827",ok:"#15803d",error:"#b91c1c",shadow:"0 24px 80px rgba(148, 163, 184, 0.3)",colorScheme:"light"}};function I(t){const s=q[t in q?t:"violet"],a=document.documentElement;a.style.setProperty("--bg",s.bg),a.style.setProperty("--bg-strong",s.bgStrong),a.style.setProperty("--panel",s.panel),a.style.setProperty("--panel-2",s.panel2),a.style.setProperty("--border",s.border),a.style.setProperty("--border-strong",s.borderStrong),a.style.setProperty("--primary",s.primary),a.style.setProperty("--accent",s.accent),a.style.setProperty("--muted",s.muted),a.style.setProperty("--fg",s.fg),a.style.setProperty("--ok",s.ok),a.style.setProperty("--error",s.error),a.style.setProperty("--shadow",s.shadow),a.style.setProperty("color-scheme",s.colorScheme),document.body.dataset.theme=t}function ne(){return Object.keys(q)}const e={bootstrapped:!1,fatalError:"",authChecked:!1,auth:null,authBusy:!1,authPassword:"",authConfirmPassword:"",authStatus:"",authIsError:!1,page:"Recall",bootstrap:null,quotes:[],quotesLoading:!1,quotesError:"",quotesCursor:0,quotesSelected:new Set,libraryQuery:"",recallQuestion:"",recallLastQuestion:"",recallKeywords:[],recallQuotes:[],recallResponse:"",recallBusy:!1,recallError:"",recallStatus:"",recallStatusIsError:!1,recallCursor:0,recallSelected:new Set,historyEntries:[],historyLoading:!1,historyError:"",historyCursor:0,historySelected:new Set,historyDetail:null,historyDetailLoading:!1,historyDetailError:"",historyStatus:"",historyStatusIsError:!1,historyQuoteCursor:0,historyQuoteSelected:new Set,settings:ht(),settingsBusy:!1,settingsStatus:"",settingsIsError:!1,passwordForm:{current:"",next:"",confirm:"",busy:!1,status:"",isError:!1},apiToken:{loading:!1,hasToken:!1,tokenPrefix:""},overlay:null,toast:null};let b=null,F=!1,N=null,g=null;const le=["Recall","History","Quotes","Settings"];function ue(t){b=t,F||(de(t),F=!0),o(),N||(N=ce())}async function ce(){try{const t=await re();if(e.auth=await t.AuthStatus(),e.authChecked=!0,e.auth.runtime==="web"&&!e.auth.authenticated){o();return}await j()}catch(t){e.authChecked=!0,e.bootstrapped=!0,e.fatalError=c(t),o()}}async function j(){var s;await re();const t=await u().BootstrapState();e.bootstrap=t,e.bootstrapped=!0,e.page="Recall",e.settings=vt(t),I(e.settings.theme),(s=t.profile)!=null&&s.DisplayName||(e.overlay={type:"namePrompt",name:"",busy:!1,status:"",isError:!1}),o(),await K(),await f()}function de(t){t.addEventListener("click",s=>{fe(s)}),t.addEventListener("input",be),t.addEventListener("change",me),t.addEventListener("submit",s=>{ge(s)}),window.addEventListener("keydown",s=>{we(s)})}async function U(){if(!(!e.auth||e.authBusy)){if(!e.authPassword.trim()){e.authStatus="Password is required.",e.authIsError=!0,o();return}e.authBusy=!0,e.authStatus="",e.authIsError=!1,o();try{await u().Login(e.authPassword),e.authPassword="",e.authConfirmPassword="",e.auth=await u().AuthStatus(),await j()}catch(t){e.authStatus=c(t),e.authIsError=!0,o()}finally{e.authBusy=!1}}}async function pe(){await u().Logout(),e.auth=await u().AuthStatus(),e.bootstrapped=!1,e.bootstrap=null,e.overlay=null,e.quotes=[],e.historyEntries=[],e.historyDetail=null,e.authPassword="",e.authConfirmPassword="",e.authStatus="",e.authIsError=!1,e.apiToken={loading:!1,hasToken:!1,tokenPrefix:""},o()}async function K(){e.apiToken.loading=!0,o();try{const t=await u().GetAPITokenStatus();e.apiToken={loading:!1,hasToken:t.hasToken,tokenPrefix:t.tokenPrefix}}catch(t){e.apiToken.loading=!1,e.settingsStatus=c(t),e.settingsIsError=!0}o()}async function ye(){if(e.settingsBusy)return;const t=e.apiToken.hasToken;e.settingsBusy=!0,e.settingsStatus="",e.settingsIsError=!1,o();try{const s=await u().CreateAPIToken();e.apiToken={loading:!1,hasToken:!0,tokenPrefix:s.tokenPrefix},e.overlay={type:"apiTokenReveal",token:s.token,tokenPrefix:s.tokenPrefix},e.settingsStatus=t?"API token renewed.":"API token created.",e.settingsIsError=!1}catch(s){e.settingsStatus=c(s),e.settingsIsError=!0}finally{e.settingsBusy=!1,o()}}async function ve(){if(!e.passwordForm.busy){e.passwordForm.busy=!0,e.passwordForm.status="",o();try{await u().ChangePassword(e.passwordForm.current,e.passwordForm.next,e.passwordForm.confirm),e.passwordForm={current:"",next:"",confirm:"",busy:!1,status:"Password updated.",isError:!1}}catch(t){e.passwordForm.busy=!1,e.passwordForm.status=c(t),e.passwordForm.isError=!0}o()}}async function he(t){var r,i;const s=(r=t.files)==null?void 0:r[0];if(!s||((i=e.overlay)==null?void 0:i.type)!=="importQuotes")return;const a=await s.text();e.overlay.filename=s.name,e.overlay.payload=a,e.overlay.path=s.name,e.overlay.status=`Loaded ${s.name}`,e.overlay.isError=!1,o()}async function fe(t){var i,l;const s=t.target;if(!(s instanceof HTMLElement))return;const a=s.closest("[data-action]");if(!a)return;switch(a.dataset.action??""){case"auth-login":await U();return;case"auth-logout":await pe();return;case"nav":await $e(a.dataset.page);return;case"quotes-refresh":await f();return;case"history-refresh":await L();return;case"history-view-current":await Se();return;case"history-back":$();return;case"recall-save-quote":await He();return;case"history-save-quote":await Ae();return;case"history-delete-current":qe();return;case"history-select-all":Ge();return;case"history-deselect-all":Ve();return;case"quote-add":W("add");return;case"quote-import":De();return;case"library-clear-filters":e.libraryQuery="",e.quotesCursor=0,o();return;case"quote-select-all":Ue(a.dataset.context);return;case"quote-deselect-all":Ke(a.dataset.context);return;case"quote-edit-current":Ee(a.dataset.context);return;case"quote-delete-current":ke(a.dataset.context);return;case"quote-share-current":await Qe(a.dataset.context);return;case"quote-inspect":if(s.closest("input, button, label"))return;Ie(a.dataset.context,Number(a.dataset.index??"0"));return;case"set-cursor":if(s.closest("input, button, label"))return;Oe(a.dataset.context,Number(a.dataset.index??"0"));return;case"history-set-cursor":if(s.closest("input, button, label"))return;Je(Number(a.dataset.index??"0"));return;case"history-open":await S(Number(a.dataset.id??"0"));return;case"share-toggle-payload":((i=e.overlay)==null?void 0:i.type)==="shareQuotes"&&(e.overlay.showPayload=!e.overlay.showPayload,o());return;case"import-toggle-payload":((l=e.overlay)==null?void 0:l.type)==="importQuotes"&&(e.overlay.showPayload=!e.overlay.showPayload,o());return;case"profile-save":await z();return;case"quote-editor-save":await J();return;case"quote-editor-refine":await Y();return;case"quote-editor-apply-refined":Le();return;case"quote-editor-reject-refined":Pe();return;case"overlay-close":V();return;case"delete-confirm":await Ce();return;case"share-browse":await Re();return;case"share-save":await xe();return;case"import-browse":await Te();return;case"import-run":await Me();return;case"settings-fetch-models":await Fe();return;case"settings-save":await G();return;case"settings-browse-root":await Ne();return;case"settings-clear-root":Be();return;case"settings-change-password":await ve();return;case"settings-create-api-token":await ye();return;case"recall-run":await P();return;case"use-last-question":e.recallQuestion=e.recallLastQuestion,o();return;case"reuse-history-question":if(e.historyDetail)e.recallQuestion=e.historyDetail.Question;else{const d=x()[0];d&&(e.recallQuestion=d.Question)}e.page="Recall",o();return;default:return}}function be(t){var r,i,l,d;const s=t.target;if(!(s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement))return;switch(s.dataset.bind??""){case"auth-password":e.authPassword=s.value;return;case"auth-confirm-password":e.authConfirmPassword=s.value;return;case"recall-question":e.recallQuestion=s.value;return;case"library-query":e.libraryQuery=s.value,e.quotesCursor=0,o();return;case"profile-name":((r=e.overlay)==null?void 0:r.type)==="namePrompt"&&(e.overlay.name=s.value);return;case"quote-editor-content":((i=e.overlay)==null?void 0:i.type)==="quoteEditor"&&(e.overlay.content=s.value);return;case"share-path":((l=e.overlay)==null?void 0:l.type)==="shareQuotes"&&(e.overlay.path=s.value);return;case"import-path":((d=e.overlay)==null?void 0:d.type)==="importQuotes"&&(e.overlay.path=s.value);return;case"settings-host":e.settings.host=s.value;return;case"settings-port":e.settings.port=s.value;return;case"settings-api-key":e.settings.apiKey=s.value;return;case"settings-model-filter":e.settings.modelFilter=s.value,M(e.settings),o();return;case"settings-max-results":e.settings.maxResults=s.value;return;case"settings-min-relevance":e.settings.minRelevance=s.value;return;case"settings-theme":e.settings.theme=s.value,I(e.settings.theme);return;case"settings-web-port":e.settings.webPort=s.value;return;case"settings-root-dir":e.settings.rootDir=s.value;return;case"settings-password-current":e.passwordForm.current=s.value;return;case"settings-password-next":e.passwordForm.next=s.value;return;case"settings-password-confirm":e.passwordForm.confirm=s.value;return;default:return}}function me(t){const s=t.target;if(!(s instanceof HTMLInputElement||s instanceof HTMLSelectElement))return;switch(s.dataset.bind??""){case"quote-selected":je(s.dataset.context,Number(s.dataset.id??"0"),s.checked);return;case"history-selected":Ye(Number(s.dataset.id??"0"),s.checked);return;case"settings-https":s instanceof HTMLInputElement&&(e.settings.https=s.checked);return;case"settings-mock-llm":s instanceof HTMLInputElement&&(e.settings.mockLLM=s.checked);return;case"settings-model":e.settings.model=s.value;return;case"import-file":s instanceof HTMLInputElement&&he(s);return;default:return}}async function ge(t){const s=t.target;if(s instanceof HTMLFormElement)switch(t.preventDefault(),s.dataset.form){case"auth-login":await U();return;case"auth-setup":await submitAuthSetup();return;case"recall":await P();return;case"profile":await z();return;default:return}}async function we(t){var a,r;const s=document.activeElement;if(t.key==="Escape"&&e.overlay&&e.overlay.type!=="namePrompt"){t.preventDefault(),V();return}if(t.ctrlKey&&t.key.toLowerCase()==="s"){if(((a=e.overlay)==null?void 0:a.type)==="quoteEditor"){t.preventDefault(),await J();return}!e.overlay&&e.page==="Settings"&&(t.preventDefault(),await G());return}if(t.ctrlKey&&t.key.toLowerCase()==="r"&&((r=e.overlay)==null?void 0:r.type)==="quoteEditor"){t.preventDefault(),await Y();return}t.key==="Enter"&&!t.shiftKey&&s instanceof HTMLInputElement&&s.dataset.bind==="recall-question"&&(t.preventDefault(),await P())}async function $e(t){e.page=t,o(),t==="Quotes"&&await f(),t==="History"&&await L(),t==="Settings"&&await K()}async function f(){e.quotesLoading=!0,e.quotesError="",o();try{const t=await u().ListQuotes();e.quotes=t,e.quotesCursor=h(e.quotesCursor,t),e.quotesSelected=se(e.quotesSelected,t),e.quotesError=""}catch(t){e.quotesError=c(t)}finally{e.quotesLoading=!1,o()}}async function L(){var t;e.historyLoading=!0,e.historyError="",e.historyStatus="",e.historyStatusIsError=!1,o();try{const s=await u().ListRecallHistory(),a=((t=e.historyDetail)==null?void 0:t.ID)??null;e.historyEntries=s,e.historyCursor=H(e.historyCursor,s),e.historySelected=bt(e.historySelected,s),a===null?$():s.some(r=>r.ID===a)?S(a,!0):$()}catch(s){e.historyError=c(s)}finally{e.historyLoading=!1,o()}}async function Se(){const t=x()[0];t&&await S(t.ID)}async function S(t,s=!1){var a;if(!(!Number.isFinite(t)||t<=0)&&!(e.historyDetailLoading&&((a=e.historyDetail)==null?void 0:a.ID)===t)&&!(e.historyDetail&&e.historyDetail.ID===t&&!e.historyDetailError)){e.historyDetailLoading=!0,e.historyDetailError="",s||(e.historyStatus="",e.historyStatusIsError=!1),o();try{const r=await u().GetRecallHistory(t);e.historyDetail=r,e.historyQuoteCursor=h(e.historyQuoteCursor,r.Quotes),e.historyQuoteSelected=se(e.historyQuoteSelected,r.Quotes)}catch(r){e.historyDetailError=c(r)}finally{e.historyDetailLoading=!1,o()}}}function $(){e.historyDetail=null,e.historyDetailLoading=!1,e.historyDetailError="",e.historyQuoteCursor=0,e.historyQuoteSelected=new Set,o()}function W(t,s){e.overlay={type:"quoteEditor",mode:t,quoteId:(s==null?void 0:s.ID)??null,content:(s==null?void 0:s.Content)??"",busy:!1,status:"",isError:!1,previewOriginal:"",previewRefined:""},o()}function Ee(t){const s=We(t);s&&W("edit",s)}function ke(t){var a;const s=((a=e.overlay)==null?void 0:a.type)==="quoteInspect"&&e.overlay.context===t?[e.overlay.quote.ID]:C(t).map(r=>r.ID);s.length!==0&&(e.overlay={type:"deleteQuotes",context:t,ids:s,busy:!1,status:"",isError:!1},o())}function qe(){const t=x().map(s=>s.ID);t.length!==0&&(e.overlay={type:"deleteHistory",ids:t,busy:!1,status:"",isError:!1},o())}async function Qe(t){var a,r,i;const s=((a=e.overlay)==null?void 0:a.type)==="quoteInspect"&&e.overlay.context===t?[e.overlay.quote]:C(t);if(s.length!==0){e.overlay={type:"shareQuotes",context:t,ids:s.map(l=>l.ID),path:"",payload:"",showPayload:!1,busy:!0,status:"",isError:!1},o();try{const l=await u().PreviewQuoteExport(s.map(d=>d.ID));if(((r=e.overlay)==null?void 0:r.type)!=="shareQuotes")return;e.overlay.payload=l,e.overlay.busy=!1,e.overlay.status="Share payload ready. Save it to a file and transfer it manually.",e.overlay.isError=!1}catch(l){if(((i=e.overlay)==null?void 0:i.type)!=="shareQuotes")return;e.overlay.busy=!1,e.overlay.status=c(l),e.overlay.isError=!0}o()}}function De(){e.overlay={type:"importQuotes",path:"",payload:"",filename:"",showPayload:!1,busy:!1,status:"",isError:!1,result:null},o()}function Ie(t,s){const a=E(t),r=h(s,a),i=a[r];i&&(t==="quotes"?e.quotesCursor=r:t==="recall"?e.recallCursor=r:e.historyQuoteCursor=r,e.overlay={type:"quoteInspect",context:t,quote:i},o())}async function z(){var s,a;if(((s=e.overlay)==null?void 0:s.type)!=="namePrompt"||e.overlay.busy)return;const t=e.overlay.name.trim();if(!t){e.overlay.status="Please enter a name to continue.",e.overlay.isError=!0,o();return}e.overlay.busy=!0,e.overlay.status="Saving profile…",e.overlay.isError=!1,o();try{const r=await u().SaveUserProfile(t);e.bootstrap&&(e.bootstrap.profile=r,e.bootstrap.greeting=`Hi! ${r.DisplayName}`),e.overlay=null}catch(r){((a=e.overlay)==null?void 0:a.type)==="namePrompt"&&(e.overlay.busy=!1,e.overlay.status=c(r),e.overlay.isError=!0)}o()}async function J(){var s,a;if(((s=e.overlay)==null?void 0:s.type)!=="quoteEditor"||e.overlay.busy)return;const t=e.overlay.content.trim();if(!t){e.overlay.status="Nothing to save.",e.overlay.isError=!0,o();return}e.overlay.busy=!0,e.overlay.status="Refining draft...",e.overlay.isError=!1,o();try{const r=e.overlay.mode==="add"?await u().AddQuote(t):await u().UpdateQuote(e.overlay.quoteId??0,t);e.overlay=null,R(r),await f()}catch(r){((a=e.overlay)==null?void 0:a.type)==="quoteEditor"&&(e.overlay.busy=!1,e.overlay.status=c(r),e.overlay.isError=!0),o()}}async function Y(){var s,a,r;if(((s=e.overlay)==null?void 0:s.type)!=="quoteEditor"||e.overlay.busy)return;const t=e.overlay.content.trim();if(!t){e.overlay.status="Nothing to refine.",e.overlay.isError=!0,o();return}e.overlay.busy=!0,e.overlay.status="",o();try{const i=await u().RefineQuoteDraft(t);if(((a=e.overlay)==null?void 0:a.type)!=="quoteEditor")return;e.overlay.busy=!1,e.overlay.previewOriginal=t,e.overlay.previewRefined=i,e.overlay.status="",e.overlay.isError=!1}catch(i){((r=e.overlay)==null?void 0:r.type)==="quoteEditor"&&(e.overlay.busy=!1,e.overlay.status=c(i),e.overlay.isError=!0)}o()}function Le(){var t;((t=e.overlay)==null?void 0:t.type)==="quoteEditor"&&(e.overlay.content=e.overlay.previewRefined,e.overlay.previewOriginal="",e.overlay.previewRefined="",e.overlay.status="Refined draft applied. Review it, then save.",e.overlay.isError=!1,o())}function Pe(){var t;((t=e.overlay)==null?void 0:t.type)==="quoteEditor"&&(e.overlay.previewOriginal="",e.overlay.previewRefined="",e.overlay.status="Refined draft discarded.",e.overlay.isError=!1,o())}async function Ce(){var t,s,a,r;if(((t=e.overlay)==null?void 0:t.type)==="deleteHistory"){if(e.overlay.busy)return;e.overlay.busy=!0,e.overlay.status="",o();try{await u().DeleteRecallHistory(e.overlay.ids),Xe(e.overlay.ids),e.overlay=null,await L()}catch(i){((s=e.overlay)==null?void 0:s.type)==="deleteHistory"&&(e.overlay.busy=!1,e.overlay.status=c(i),e.overlay.isError=!0),o()}return}if(!(((a=e.overlay)==null?void 0:a.type)!=="deleteQuotes"||e.overlay.busy)){e.overlay.busy=!0,e.overlay.status="",o();try{await u().DeleteQuotes(e.overlay.ids),ze(e.overlay.ids),e.overlay=null,await f()}catch(i){((r=e.overlay)==null?void 0:r.type)==="deleteQuotes"&&(e.overlay.busy=!1,e.overlay.status=c(i),e.overlay.isError=!0),o()}}}async function Re(){var t,s,a;if(!(((t=e.overlay)==null?void 0:t.type)!=="shareQuotes"||e.overlay.busy)){if(y()){e.overlay.path="irecall-share.json",o();return}try{const r=await u().SelectQuoteExportFile();r&&((s=e.overlay)==null?void 0:s.type)==="shareQuotes"&&(e.overlay.path=r,o())}catch(r){((a=e.overlay)==null?void 0:a.type)==="shareQuotes"&&(e.overlay.status=c(r),e.overlay.isError=!0,o())}}}async function xe(){var s,a,r;if(((s=e.overlay)==null?void 0:s.type)!=="shareQuotes"||e.overlay.busy)return;if(y()){const i=e.overlay.path.trim()||"irecall-share.json";if(!e.overlay.payload.trim()){e.overlay.status="Export payload is not ready yet.",e.overlay.isError=!0,o();return}wt(i,e.overlay.payload),e.overlay.status=`Downloaded ${i}`,e.overlay.isError=!1,o();return}const t=e.overlay.path.trim();if(!t){e.overlay.status="Choose a file path for the export.",e.overlay.isError=!0,o();return}if(!e.overlay.payload.trim()){e.overlay.status="Export payload is not ready yet.",e.overlay.isError=!0,o();return}e.overlay.busy=!0,e.overlay.status="",o();try{await u().ExportQuotesToFile(e.overlay.ids,t),((a=e.overlay)==null?void 0:a.type)==="shareQuotes"&&(e.overlay.busy=!1,e.overlay.status=`Saved share payload to ${t}`,e.overlay.isError=!1,o())}catch(i){((r=e.overlay)==null?void 0:r.type)==="shareQuotes"&&(e.overlay.busy=!1,e.overlay.status=c(i),e.overlay.isError=!0,o())}}async function Te(){var t,s,a;if(!(((t=e.overlay)==null?void 0:t.type)!=="importQuotes"||e.overlay.busy)){if(y()){const r=document.querySelector('[data-bind="import-file"]');r==null||r.click();return}try{const r=await u().SelectQuoteImportFile();r&&((s=e.overlay)==null?void 0:s.type)==="importQuotes"&&(e.overlay.path=r,o())}catch(r){((a=e.overlay)==null?void 0:a.type)==="importQuotes"&&(e.overlay.status=c(r),e.overlay.isError=!0,o())}}}async function Me(){var a,r,i;if(((a=e.overlay)==null?void 0:a.type)!=="importQuotes"||e.overlay.busy)return;const t=e.overlay.path.trim(),s=e.overlay.payload.trim();if(y()){if(!s){e.overlay.status="Choose a file to import.",e.overlay.isError=!0,o();return}}else if(!t){e.overlay.status="Choose a file to import.",e.overlay.isError=!0,o();return}e.overlay.busy=!0,e.overlay.status="",e.overlay.result=null,o();try{const l=y()?await u().ImportQuotesPayload(s):await u().ImportQuotesFromFile(t);if(((r=e.overlay)==null?void 0:r.type)!=="importQuotes")return;e.overlay.busy=!1,e.overlay.result=l,e.overlay.status=`Imported quotes. inserted=${l.Inserted} updated=${l.Updated} duplicates=${l.Duplicates} stale=${l.Stale}`,e.overlay.isError=!1,await f()}catch(l){((i=e.overlay)==null?void 0:i.type)==="importQuotes"&&(e.overlay.busy=!1,e.overlay.status=c(l),e.overlay.isError=!0,o())}}async function P(){if(e.recallBusy)return;const t=e.recallQuestion.trim();if(!t){e.recallError="Enter a recall question first.",o();return}e.recallBusy=!0,e.recallError="",e.recallStatus="",e.recallStatusIsError=!1,e.recallLastQuestion=t,e.recallKeywords=[],e.recallQuotes=[],e.recallResponse="",e.recallCursor=0,e.recallSelected=new Set,o();try{const s=await u().RunRecall(t);e.recallKeywords=s.keywords,e.recallQuotes=s.quotes,e.recallResponse=s.response,e.recallLastQuestion=s.question||t,e.recallCursor=0,e.recallSelected=new Set,e.recallQuestion=""}catch(s){e.recallError=c(s)}finally{e.recallBusy=!1,o()}}async function He(){const t=e.recallLastQuestion.trim(),s=e.recallResponse.trim();if(!t||!s){e.recallStatus="Run a recall first before saving it as a quote.",e.recallStatusIsError=!0,o();return}try{const a=await u().SaveRecallAsQuote(t,s,e.recallKeywords);R(a),await f(),e.recallStatus="Saved recall as quote.",e.recallStatusIsError=!1,X("Saved the current grounded answer as a quote.")}catch(a){e.recallStatus=c(a),e.recallStatusIsError=!0}o()}async function Ae(){const t=e.historyDetail;if(t){try{const s=await u().SaveRecallAsQuote(t.Question,t.Response,[]);R(s),await f(),e.historyStatus="Saved history entry as quote.",e.historyStatusIsError=!1,X("Saved the selected activity session as a quote.")}catch(s){e.historyStatus=c(s),e.historyStatusIsError=!0}o()}}async function Fe(){if(e.settingsBusy)return;let t;try{t=ee(e.settings)}catch(s){e.settingsStatus=c(s),e.settingsIsError=!0,o();return}e.settingsBusy=!0,e.settingsStatus="",o();try{const s=await u().FetchModels(t);e.settings.models=s,M(e.settings),e.settingsStatus=s.length>0?`Fetched ${s.length} models.`:"No models returned.",e.settingsIsError=!1}catch(s){e.settingsStatus=c(s),e.settingsIsError=!0}finally{e.settingsBusy=!1,o()}}async function G(){var s;if(e.settingsBusy)return;let t;try{t=ft(e.settings)}catch(a){e.settingsStatus=c(a),e.settingsIsError=!0,o();return}e.settingsBusy=!0,e.settingsStatus="",o();try{const a=await u().SaveSettings(t),r=await u().BootstrapState();e.bootstrap=r,e.settings=_(r.settings,e.settings.models),I(e.settings.theme);const i=((s=e.auth)==null?void 0:s.runtime)==="web"&&e.auth.currentPort>0&&e.auth.currentPort!==a.Web.Port;e.settingsStatus=i?"Saved. Restart the web server to apply the new port.":"Saved.",e.settingsIsError=!1}catch(a){e.settingsStatus=c(a),e.settingsIsError=!0}finally{e.settingsBusy=!1,o()}}async function Ne(){if(!(e.settingsBusy||y()))try{const t=await u().SelectRootDir();if(!t)return;e.settings.rootDir=t,e.settingsStatus="Selected a new storage root. Save changes to apply it.",e.settingsIsError=!1,o()}catch(t){e.settingsStatus=c(t),e.settingsIsError=!0,o()}}function Be(){e.settings.rootDir="",e.settingsStatus="Storage root cleared. Save changes to return to the default app directories.",e.settingsIsError=!1,o()}function V(){e.overlay&&e.overlay.type!=="namePrompt"&&("busy"in e.overlay&&e.overlay.busy||(e.overlay=null,o()))}function X(t,s=!1){e.toast={message:t,isError:s},g!==null&&window.clearTimeout(g),g=window.setTimeout(()=>{e.toast=null,g=null,o()},2600)}function E(t){var s;return t==="quotes"?Z():t==="recall"?e.recallQuotes:((s=e.historyDetail)==null?void 0:s.Quotes)??[]}function Oe(t,s){var r;const a=E(t);if(t==="quotes")e.quotesCursor=h(s,a);else if(t==="recall")e.recallCursor=h(s,e.recallQuotes);else{const i=((r=e.historyDetail)==null?void 0:r.Quotes)??[];e.historyQuoteCursor=h(s,i)}o()}function je(t,s,a){const r=t==="quotes"?e.quotesSelected:t==="recall"?e.recallSelected:e.historyQuoteSelected;a?r.add(s):r.delete(s),o()}function Ue(t){const s=E(t),a=new Set(s.map(r=>r.ID));t==="quotes"?e.quotesSelected=a:t==="recall"?e.recallSelected=a:e.historyQuoteSelected=a,o()}function Ke(t){t==="quotes"?e.quotesSelected=new Set:t==="recall"?e.recallSelected=new Set:e.historyQuoteSelected=new Set,o()}function C(t){const s=E(t),a=t==="quotes"?e.quotesCursor:t==="recall"?e.recallCursor:e.historyQuoteCursor,r=h(a,s),i=t==="quotes"?e.quotesSelected:t==="recall"?e.recallSelected:e.historyQuoteSelected,l=s.filter(d=>i.has(d.ID));return l.length>0?l:s[r]?[s[r]]:[]}function We(t){var s;return((s=e.overlay)==null?void 0:s.type)==="quoteInspect"&&e.overlay.context===t?e.overlay.quote:C(t)[0]??null}function Z(){const t=e.libraryQuery.trim().toLowerCase();return e.quotes.filter(s=>t?[s.Content,s.AuthorName,s.SourceName,...s.Tags].join(" ").toLowerCase().includes(t):!0)}function R(t){e.quotes=k(e.quotes,t),e.recallQuotes=k(e.recallQuotes,t),e.historyDetail&&(e.historyDetail={...e.historyDetail,Quotes:k(e.historyDetail.Quotes,t)}),o()}function ze(t){var a;const s=new Set(t);e.quotes=e.quotes.filter(r=>!s.has(r.ID)),e.recallQuotes=e.recallQuotes.filter(r=>!s.has(r.ID)),e.historyDetail&&(e.historyDetail={...e.historyDetail,Quotes:e.historyDetail.Quotes.filter(r=>!s.has(r.ID))}),e.quotesSelected=new Set([...e.quotesSelected].filter(r=>!s.has(r))),e.recallSelected=new Set([...e.recallSelected].filter(r=>!s.has(r))),e.historyQuoteSelected=new Set([...e.historyQuoteSelected].filter(r=>!s.has(r))),e.quotesCursor=h(e.quotesCursor,e.quotes),e.recallCursor=h(e.recallCursor,e.recallQuotes),e.historyQuoteCursor=h(e.historyQuoteCursor,((a=e.historyDetail)==null?void 0:a.Quotes)??[]),o()}function Je(t){e.historyCursor=H(t,e.historyEntries);const s=e.historyEntries[e.historyCursor];s&&S(s.ID,!0),o()}function Ye(t,s){s?e.historySelected.add(t):e.historySelected.delete(t),o()}function Ge(){e.historySelected=new Set(e.historyEntries.map(t=>t.ID)),o()}function Ve(){e.historySelected=new Set,o()}function x(){const t=e.historyEntries.filter(s=>e.historySelected.has(s.ID));return t.length>0?t:e.historyEntries[e.historyCursor]?[e.historyEntries[e.historyCursor]]:[]}function Xe(t){const s=new Set(t);if(e.historyEntries=e.historyEntries.filter(a=>!s.has(a.ID)),e.historySelected=new Set([...e.historySelected].filter(a=>!s.has(a))),e.historyCursor=H(e.historyCursor,e.historyEntries),e.historyDetail&&s.has(e.historyDetail.ID)){$();return}o()}function o(){if(!b)return;const t=Ze();b.innerHTML=et(),_e(t)}function Ze(){const t=document.activeElement;if(!(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement||t instanceof HTMLSelectElement))return null;const s=t.dataset.bind;return s?{selector:`[data-bind="${s}"]`,selectionStart:t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement?t.selectionStart:null,selectionEnd:t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement?t.selectionEnd:null}:null}function _e(t){if(!b||!t)return;const s=b.querySelector(t.selector);(s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement||s instanceof HTMLSelectElement)&&(s.focus({preventScroll:!0}),(s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement)&&t.selectionStart!==null&&t.selectionEnd!==null&&s.setSelectionRange(t.selectionStart,t.selectionEnd))}function et(){var s,a,r,i,l;if(!e.authChecked)return`
    ...
    `;if(((s=e.auth)==null?void 0:s.runtime)==="web"&&!e.auth.authenticated)return tt();if(!e.bootstrapped)return`
      <div class="shell shell-loading">
        <div class="splash">
          <div class="brand">iRecall</div>
    ...
    <div class="shell">
      ...
      ${nt()}
      ${e.overlay?pt(e.overlay):""}
      ${e.toast?dt(e.toast):""}
    </div>
  `}function tt(){var i;const t=!((i=e.auth)!=null&&i.passwordConfigured),s="auth-login";return`
    <div class="shell shell-loading">
  ...
  `}function st(){switch(e.page){case"Recall":return rt();case"Quotes":return ot();case"History":return it();case"Settings":return ut()}}function at(t){switch(t){case"Recall":return"Recall";case"Quotes":return"Quotes";case"History":return"History";case"Settings":return"Settings"}}function rt(){const t=!e.recallResponse.trim(),s=e.settings.mockLLM,a=e.recallResponse.trim()?n(e.recallResponse):'<span class="muted">Grounded response will appear here.</span>',r=e.recallKeywords.length>0?e.recallKeywords.map(i=>`<span class="keyword-chip">${n(i)}</span>`).join(""):'<span class="muted">Keywords: —</span>';return`
  ...
  `}function ot(){const t=Z(),s=h(e.quotesCursor,t),a=t.filter(r=>e.quotesSelected.has(r.ID)).length;return`
      ...
      <div class="panel page-panel">
        ...
        <div class="flow-stack">
          <section class="panel subpanel">
            ...
            ${e.historyLoading?'<div class="empty-state">Loading history…</div>':e.historyError?`<div class="status status-error">${n(e.historyError)}</div>`:e.historyEntries.length===0?'<div class="empty-state">No recall history yet. Run a question from the Recall page to create your first grounded session.</div>':lt()}
          </section>
        </div>
      </div>
    </section>
  `}function nt(){if(!e.historyDetailLoading&&!e.historyDetail&&!e.historyDetailError)return"";const t=e.historyDetail?e.historyEntries.find(r=>{var i;return r.ID===((i=e.historyDetail)==null?void 0:i.ID)})??e.historyDetail:e.historyEntries[e.historyCursor]??null,s=e.historyDetail&&t&&e.historyDetail.ID===t.ID?e.historyDetail:null,a=(s==null?void 0:s.Quotes)??[];return`
            ...
            <article class="quote-card history-card${a?" is-current":""}" data-action="history-set-cursor" data-index="${s}">
              <div class="quote-topline">
                ...
                <div class="quote-topline-meta">
                  <span class="quote-version">${n(mt(t.CreatedAt))}</span>
                </div>
              </div>
          ...
          <section class="panel subpanel settings-secondary">
            ...
            <label class="field">
              ...
              <select class="select-input" data-bind="settings-theme">
                ${ne().map(v=>`
                      <option value="${v}"${v===e.settings.theme?" selected":""}>${v}</option>
                    `).join("")}
              </select>
            </label>
          </section>
          ...
          <section class="panel subpanel settings-secondary">
            ...
            <label class="field">
              ...
              <input
                ...
                value="${p(e.settings.rootDir)}"
                placeholder="${p(y()?"/path/to/irecall-root":"Choose a folder or enter a full path")}"
              />
            </label>
            <div class="toolbar">
              ${y()?"":`<button class="button" data-action="settings-browse-root" type="button" ${e.settingsBusy?"disabled":""}>Browse…</button>`}
              <button class="button" data-action="settings-clear-root" type="button" ${e.settingsBusy?"disabled":""}>Use Default Paths</button>
            </div>
            <div class="settings-hint muted">
              ${y()?"Enter an absolute path to keep data, config, state, and the database under one custom root. Leave it empty to use the default app directories.":"Choose a folder to keep data, config, state, and the database under one custom root. Leave it empty to use the default app directories."}
            </div>
            <label class="field">
              <span>Web Port</span>
  ...
  `}function T(t,s,a,r,i){return s.length===0?`<div class="empty-state">${t==="quotes"?"No quotes yet. Add one or import a shared payload.":"No reference quotes for this question yet."}</div>`:`
    <div class="quote-list">
      ${s.map((l,d)=>{const m=d===a,v=t!=="quotes",A=!l.IsOwnedByMe&&l.SourceName?`<span class="meta-accent">${n(l.SourceName)}</span>`:`<span>${n(l.AuthorName||"You")}</span>`,ie=i?`
              <div class="quote-meta">
                <span class="muted">Tags</span>
                <span>${l.Tags.length>0?n(gt(l.Tags,4)):"(none)"}</span>
              </div>
            `:"";return`
            <article class="quote-card${m?" is-current":""}${v?" quote-card-minimal":""}" data-action="quote-inspect" data-context="${t}" data-index="${d}">
              <div class="quote-topline">
                ${v?`<div class="quote-topline-meta">
                    ...
                    `}
                <div class="quote-topline-meta">
                  ${v?`<span class="quote-source-inline">${A}</span>`:`<span class="quote-version">${n(Q(l.UpdatedAt))}</span>
                  <span class="quote-badge">${l.IsOwnedByMe?"Owned":"Imported"}</span>`}
                </div>
              </div>
              <div class="quote-content">${n(D(l.Content,t==="quotes"?160:136))}</div>
              ${v?`<div class="quote-actions-inline"><button class="button button-subtle" data-action="quote-inspect" data-context="${t}" data-index="${d}" type="button">Details</button></div>`:`<div class="quote-meta"><span class="muted">${!l.IsOwnedByMe&&l.SourceName?"Imported from":"Author"}</span> ${A}</div>`}
              ${ie}
            </article>
          `}).join("")}
    </div>
  `}function ct(t,s){return t?`
    <div class="detail-stack">
      <div class="detail-block">
  ...
  `:'<div class="empty-state">Select a quote to inspect the full note, provenance, and available actions.</div>'}function Q(t){const s=new Date(t);return Number.isNaN(s.getTime())?t:s.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function B(t){return!Number.isFinite(t)||t<=0?"0 B":t<1024?`${Math.round(t)} B`:t<1024*1024?`${(t/1024).toFixed(1)} KB`:`${(t/(1024*1024)).toFixed(1)} MB`}function dt(t){return`
    <div class="toast-stack" role="status" aria-live="polite">
      <div class="toast${t.isError?" is-error":""}">${n(t.message)}</div>
    </div>
  `}function pt(t){switch(t.type){case"namePrompt":return`
        <div class="overlay-backdrop">
          <div class="modal">
      ...
      `;case"deleteHistory":return`
        <div class="overlay-backdrop">
          <div class="modal">
            ...
            <div class="summary-list">
              ${yt(t.ids).map((a,r)=>`<div class="summary-item">[${r+1}] ${n(w(a.Question,140))}</div>`).join("")}
            </div>
            ${t.status?`<div class="status ${t.isError?"status-error":"status-ok"}">${n(t.status)}</div>`:""}
            <div class="modal-actions">
              <button class="button button-danger" data-action="delete-confirm" type="button" ${t.busy?"disabled":""}>
      ...
      `;case"notice":return""}}function O(t,s){var i;const a=t==="quotes"?e.quotes:t==="recall"?e.recallQuotes:((i=e.historyDetail)==null?void 0:i.Quotes)??[],r=new Set(s);return a.filter(l=>r.has(l.ID))}function yt(t){const s=new Set(t);return e.historyEntries.filter(a=>s.has(a.ID))}function vt(t){return _(t.settings,[])}function _(t,s){var r,i;const a={host:t.Provider.Host,port:String(t.Provider.Port),https:t.Provider.HTTPS,mockLLM:((r=t.Debug)==null?void 0:r.MockLLM)??!1,apiKey:t.Provider.APIKey,modelFilter:"",model:t.Provider.Model,maxResults:String(t.Search.MaxResults),minRelevance:String(t.Search.MinRelevance),theme:t.Theme||"violet",webPort:String(((i=t.Web)==null?void 0:i.Port)??9527),rootDir:t.RootDir??"",models:s};return M(a),a}function ht(){return{host:"",port:"11434",https:!1,mockLLM:!1,apiKey:"",modelFilter:"",model:"",maxResults:"5",minRelevance:"0",theme:"violet",webPort:"9527",rootDir:"",models:[]}}function ee(t){const s=Number.parseInt(t.port.trim(),10);if(!Number.isInteger(s)||s<1||s>65535)throw new Error("Port must be a number between 1 and 65535.");return{Host:t.host.trim(),Port:s,HTTPS:t.https,APIKey:t.apiKey,Model:t.model}}function ft(t){const s=ee(t),a=Number.parseInt(t.maxResults.trim(),10),r=Number.parseInt(t.webPort.trim(),10);if(!Number.isInteger(a)||a<1||a>20)throw new Error("Max ref quotes must be between 1 and 20.");if(!Number.isInteger(r)||r<1||r>65535)throw new Error("Web port must be a number between 1 and 65535.");const i=Number.parseFloat(t.minRelevance.trim());if(Number.isNaN(i))throw new Error("Min relevance must be a decimal number.");if(i<0||i>1)throw new Error("Min relevance must be between 0.0 and 1.0.");return{Provider:s,Search:{MaxResults:a,MinRelevance:i},Debug:{MockLLM:t.mockLLM},Theme:t.theme,Web:{Port:r},RootDir:t.rootDir.trim()}}function te(t){const s=t.modelFilter.trim().toLowerCase();return s?t.models.filter(a=>a.toLowerCase().includes(s)):t.models}function M(t){if(t.models.length===0)return;const s=te(t);s.length!==0&&(s.includes(t.model)||(t.model=s[0]))}function k(t,s){return t.map(a=>a.ID===s.ID?s:a)}function h(t,s){return s.length===0?0:Math.min(Math.max(t,0),s.length-1)}function se(t,s){const a=new Set(s.map(r=>r.ID));return new Set([...t].filter(r=>a.has(r)))}function H(t,s){return s.length===0?0:Math.min(Math.max(t,0),s.length-1)}function bt(t,s){const a=new Set(s.map(r=>r.ID));return new Set([...t].filter(r=>a.has(r)))}function n(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function p(t){return n(t)}function w(t,s){const a=t.replace(/\s+/g," ").trim();return a.length<=s?a:`${a.slice(0,s-1).trimEnd()}…`}function mt(t){const s=new Date(t);return Number.isNaN(s.getTime())?t:s.toLocaleString()}function gt(t,s){return t.length===0?"":t.length<=s?t.join(" · "):`${t.slice(0,s).join(" · ")} · +${t.length-s} more`}function D(t,s){return w(t,Math.max(8,s))}function y(){var t;return((t=e.auth)==null?void 0:t.runtime)==="web"}function wt(t,s){const a=new Blob([s],{type:"application/json;charset=utf-8"}),r=URL.createObjectURL(a),i=document.createElement("a");i.href=r,i.download=t,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}function c(t){return t instanceof Error?t.message:String(t)}function ae(){var s,a,r;const t=[(s=window.go)==null?void 0:s.backend,(a=window.go)==null?void 0:a.app,(r=window.go)==null?void 0:r.main];for(const i of t)if(i!=null&&i.App)return i.App;return null}async function re(t=3e3){const s=Date.now();for(;;){const a=ae();if(a)return a;if(Date.now()-s>=t)throw new Error("Wails backend bridge is unavailable.");await new Promise(r=>window.setTimeout(r,25))}}function u(){const t=ae();if(!t)throw new Error("Wails backend bridge is unavailable.");return t}const oe=document.querySelector("#app");if(!oe)throw new Error("Missing #app root");ue(oe);
