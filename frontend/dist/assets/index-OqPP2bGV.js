(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const u of n.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&r(u)}).observe(document,{childList:!0,subtree:!0});function a(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(i){if(i.ep)return;i.ep=!0;const n=a(i);fetch(i.href,n)}})();const q={violet:{bg:"#0f172a",bgStrong:"#0b1120",panel:"rgba(17, 24, 39, 0.92)",panel2:"rgba(31, 41, 55, 0.82)",border:"#374151",borderStrong:"rgba(167, 139, 250, 0.42)",primary:"#7c3aed",accent:"#a78bfa",muted:"#94a3b8",fg:"#f9fafb",ok:"#10b981",error:"#ef4444",shadow:"0 24px 80px rgba(2, 6, 23, 0.38)",colorScheme:"dark"},forest:{bg:"#071a17",bgStrong:"#041311",panel:"rgba(9, 24, 21, 0.92)",panel2:"rgba(15, 41, 35, 0.82)",border:"#29443f",borderStrong:"rgba(45, 212, 191, 0.42)",primary:"#0f766e",accent:"#2dd4bf",muted:"#9ca3af",fg:"#ecfdf5",ok:"#22c55e",error:"#ef4444",shadow:"0 24px 80px rgba(1, 10, 9, 0.38)",colorScheme:"dark"},sunset:{bg:"#1c0f0a",bgStrong:"#130905",panel:"rgba(33, 17, 12, 0.94)",panel2:"rgba(52, 28, 18, 0.82)",border:"#5c4033",borderStrong:"rgba(251, 146, 60, 0.44)",primary:"#c2410c",accent:"#fb923c",muted:"#d6b8a6",fg:"#fffbeb",ok:"#16a34a",error:"#dc2626",shadow:"0 24px 80px rgba(20, 8, 2, 0.4)",colorScheme:"dark"},ocean:{bg:"#081824",bgStrong:"#06111a",panel:"rgba(11, 25, 38, 0.92)",panel2:"rgba(18, 40, 56, 0.82)",border:"#334155",borderStrong:"rgba(56, 189, 248, 0.42)",primary:"#0369a1",accent:"#38bdf8",muted:"#94a3b8",fg:"#f8fafc",ok:"#10b981",error:"#ef4444",shadow:"0 24px 80px rgba(3, 9, 16, 0.38)",colorScheme:"dark"},paper:{bg:"#f8fafc",bgStrong:"#e2e8f0",panel:"rgba(255, 255, 255, 0.96)",panel2:"rgba(248, 250, 252, 0.94)",border:"#cbd5e1",borderStrong:"rgba(29, 78, 216, 0.28)",primary:"#1d4ed8",accent:"#0f766e",muted:"#64748b",fg:"#111827",ok:"#15803d",error:"#b91c1c",shadow:"0 24px 80px rgba(148, 163, 184, 0.3)",colorScheme:"light"}};function k(t){const s=q[t in q?t:"violet"],a=document.documentElement;a.style.setProperty("--bg",s.bg),a.style.setProperty("--bg-strong",s.bgStrong),a.style.setProperty("--panel",s.panel),a.style.setProperty("--panel-2",s.panel2),a.style.setProperty("--border",s.border),a.style.setProperty("--border-strong",s.borderStrong),a.style.setProperty("--primary",s.primary),a.style.setProperty("--accent",s.accent),a.style.setProperty("--muted",s.muted),a.style.setProperty("--fg",s.fg),a.style.setProperty("--ok",s.ok),a.style.setProperty("--error",s.error),a.style.setProperty("--shadow",s.shadow),a.style.setProperty("color-scheme",s.colorScheme),document.body.dataset.theme=t}function ie(){return Object.keys(q)}const e={bootstrapped:!1,fatalError:"",authChecked:!1,auth:null,authBusy:!1,authPassword:"",authConfirmPassword:"",authStatus:"",authIsError:!1,page:"Recall",bootstrap:null,quotes:[],quotesLoading:!1,quotesError:"",quotesCursor:0,quotesSelected:new Set,libraryQuery:"",recallQuestion:"",recallLastQuestion:"",recallKeywords:[],recallQuotes:[],recallResponse:"",recallBusy:!1,recallError:"",recallStatus:"",recallStatusIsError:!1,recallCursor:0,recallSelected:new Set,historyEntries:[],historyLoading:!1,historyError:"",historyCursor:0,historySelected:new Set,historyDetail:null,historyDetailLoading:!1,historyDetailError:"",historyStatus:"",historyStatusIsError:!1,historyQuoteCursor:0,historyQuoteSelected:new Set,settings:dt(),settingsBusy:!1,settingsStatus:"",settingsIsError:!1,passwordForm:{current:"",next:"",confirm:"",busy:!1,status:"",isError:!1},overlay:null,toast:null};let b=null,F=!1,N=null,m=null;const ne=["Recall","History","Quotes","Settings"];function le(t){b=t,F||(ce(t),F=!0),o(),N||(N=ue())}async function ue(){try{const t=await se();if(e.auth=await t.AuthStatus(),e.authChecked=!0,e.auth.runtime==="web"&&!e.auth.authenticated){o();return}await O()}catch(t){e.authChecked=!0,e.bootstrapped=!0,e.fatalError=d(t),o()}}async function O(){var s;await se();const t=await c().BootstrapState();e.bootstrap=t,e.bootstrapped=!0,e.page="Recall",e.settings=ct(t),k(e.settings.theme),(s=t.profile)!=null&&s.DisplayName||(e.overlay={type:"namePrompt",name:"",busy:!1,status:"",isError:!1}),o(),await h()}function ce(t){t.addEventListener("click",s=>{ve(s)}),t.addEventListener("input",he),t.addEventListener("change",be),t.addEventListener("submit",s=>{fe(s)}),window.addEventListener("keydown",s=>{me(s)})}async function j(){if(!(!e.auth||e.authBusy)){if(!e.authPassword.trim()){e.authStatus="Password is required.",e.authIsError=!0,o();return}e.authBusy=!0,e.authStatus="",e.authIsError=!1,o();try{await c().Login(e.authPassword),e.authPassword="",e.authConfirmPassword="",e.auth=await c().AuthStatus(),await O()}catch(t){e.authStatus=d(t),e.authIsError=!0,o()}finally{e.authBusy=!1}}}async function de(){await c().Logout(),e.auth=await c().AuthStatus(),e.bootstrapped=!1,e.bootstrap=null,e.overlay=null,e.quotes=[],e.historyEntries=[],e.historyDetail=null,e.authPassword="",e.authConfirmPassword="",e.authStatus="",e.authIsError=!1,o()}async function pe(){if(!e.passwordForm.busy){e.passwordForm.busy=!0,e.passwordForm.status="",o();try{await c().ChangePassword(e.passwordForm.current,e.passwordForm.next,e.passwordForm.confirm),e.passwordForm={current:"",next:"",confirm:"",busy:!1,status:"Password updated.",isError:!1}}catch(t){e.passwordForm.busy=!1,e.passwordForm.status=d(t),e.passwordForm.isError=!0}o()}}async function ye(t){var r,i;const s=(r=t.files)==null?void 0:r[0];if(!s||((i=e.overlay)==null?void 0:i.type)!=="importQuotes")return;const a=await s.text();e.overlay.filename=s.name,e.overlay.payload=a,e.overlay.path=s.name,e.overlay.status=`Loaded ${s.name}`,e.overlay.isError=!1,o()}async function ve(t){var i,n;const s=t.target;if(!(s instanceof HTMLElement))return;const a=s.closest("[data-action]");if(!a)return;switch(a.dataset.action??""){case"auth-login":await j();return;case"auth-logout":await de();return;case"nav":await ge(a.dataset.page);return;case"quotes-refresh":await h();return;case"history-refresh":await I();return;case"history-view-current":await we();return;case"history-back":w();return;case"recall-save-quote":await Me();return;case"history-save-quote":await He();return;case"history-delete-current":Ee();return;case"history-select-all":We();return;case"history-deselect-all":Je();return;case"quote-add":K("add");return;case"quote-import":Qe();return;case"library-clear-filters":e.libraryQuery="",e.quotesCursor=0,o();return;case"quote-select-all":Ae(a.dataset.context);return;case"quote-deselect-all":Be(a.dataset.context);return;case"quote-edit-current":$e(a.dataset.context);return;case"quote-delete-current":Se(a.dataset.context);return;case"quote-share-current":await qe(a.dataset.context);return;case"quote-inspect":if(s.closest("input, button, label"))return;De(a.dataset.context,Number(a.dataset.index??"0"));return;case"set-cursor":if(s.closest("input, button, label"))return;Fe(a.dataset.context,Number(a.dataset.index??"0"));return;case"history-set-cursor":if(s.closest("input, button, label"))return;Ke(Number(a.dataset.index??"0"));return;case"history-open":await $(Number(a.dataset.id??"0"));return;case"share-toggle-payload":((i=e.overlay)==null?void 0:i.type)==="shareQuotes"&&(e.overlay.showPayload=!e.overlay.showPayload,o());return;case"import-toggle-payload":((n=e.overlay)==null?void 0:n.type)==="importQuotes"&&(e.overlay.showPayload=!e.overlay.showPayload,o());return;case"profile-save":await U();return;case"quote-editor-save":await W();return;case"quote-editor-refine":await J();return;case"quote-editor-apply-refined":ke();return;case"quote-editor-reject-refined":Ie();return;case"overlay-close":Y();return;case"delete-confirm":await Le();return;case"share-browse":await Ce();return;case"share-save":await Pe();return;case"import-browse":await Re();return;case"import-run":await xe();return;case"settings-fetch-models":await Te();return;case"settings-save":await z();return;case"settings-change-password":await pe();return;case"recall-run":await L();return;case"use-last-question":e.recallQuestion=e.recallLastQuestion,o();return;case"reuse-history-question":if(e.historyDetail)e.recallQuestion=e.historyDetail.Question;else{const u=R()[0];u&&(e.recallQuestion=u.Question)}e.page="Recall",o();return;default:return}}function he(t){var r,i,n,u;const s=t.target;if(!(s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement))return;switch(s.dataset.bind??""){case"auth-password":e.authPassword=s.value;return;case"auth-confirm-password":e.authConfirmPassword=s.value;return;case"recall-question":e.recallQuestion=s.value;return;case"library-query":e.libraryQuery=s.value,e.quotesCursor=0,o();return;case"profile-name":((r=e.overlay)==null?void 0:r.type)==="namePrompt"&&(e.overlay.name=s.value);return;case"quote-editor-content":((i=e.overlay)==null?void 0:i.type)==="quoteEditor"&&(e.overlay.content=s.value);return;case"share-path":((n=e.overlay)==null?void 0:n.type)==="shareQuotes"&&(e.overlay.path=s.value);return;case"import-path":((u=e.overlay)==null?void 0:u.type)==="importQuotes"&&(e.overlay.path=s.value);return;case"settings-host":e.settings.host=s.value;return;case"settings-port":e.settings.port=s.value;return;case"settings-api-key":e.settings.apiKey=s.value;return;case"settings-model-filter":e.settings.modelFilter=s.value,M(e.settings),o();return;case"settings-max-results":e.settings.maxResults=s.value;return;case"settings-min-relevance":e.settings.minRelevance=s.value;return;case"settings-theme":e.settings.theme=s.value,k(e.settings.theme);return;case"settings-web-port":e.settings.webPort=s.value;return;case"settings-password-current":e.passwordForm.current=s.value;return;case"settings-password-next":e.passwordForm.next=s.value;return;case"settings-password-confirm":e.passwordForm.confirm=s.value;return;default:return}}function be(t){const s=t.target;if(!(s instanceof HTMLInputElement||s instanceof HTMLSelectElement))return;switch(s.dataset.bind??""){case"quote-selected":Ne(s.dataset.context,Number(s.dataset.id??"0"),s.checked);return;case"history-selected":Ue(Number(s.dataset.id??"0"),s.checked);return;case"settings-https":s instanceof HTMLInputElement&&(e.settings.https=s.checked);return;case"settings-mock-llm":s instanceof HTMLInputElement&&(e.settings.mockLLM=s.checked);return;case"settings-model":e.settings.model=s.value;return;case"import-file":s instanceof HTMLInputElement&&ye(s);return;default:return}}async function fe(t){const s=t.target;if(s instanceof HTMLFormElement)switch(t.preventDefault(),s.dataset.form){case"auth-login":await j();return;case"auth-setup":await submitAuthSetup();return;case"recall":await L();return;case"profile":await U();return;default:return}}async function me(t){var a,r;const s=document.activeElement;if(t.key==="Escape"&&e.overlay&&e.overlay.type!=="namePrompt"){t.preventDefault(),Y();return}if(t.ctrlKey&&t.key.toLowerCase()==="s"){if(((a=e.overlay)==null?void 0:a.type)==="quoteEditor"){t.preventDefault(),await W();return}!e.overlay&&e.page==="Settings"&&(t.preventDefault(),await z());return}if(t.ctrlKey&&t.key.toLowerCase()==="r"&&((r=e.overlay)==null?void 0:r.type)==="quoteEditor"){t.preventDefault(),await J();return}t.key==="Enter"&&!t.shiftKey&&s instanceof HTMLInputElement&&s.dataset.bind==="recall-question"&&(t.preventDefault(),await L())}async function ge(t){e.page=t,o(),t==="Quotes"&&await h(),t==="History"&&await I()}async function h(){e.quotesLoading=!0,e.quotesError="",o();try{const t=await c().ListQuotes();e.quotes=t,e.quotesCursor=v(e.quotesCursor,t),e.quotesSelected=ee(e.quotesSelected,t),e.quotesError=""}catch(t){e.quotesError=d(t)}finally{e.quotesLoading=!1,o()}}async function I(){var t;e.historyLoading=!0,e.historyError="",e.historyStatus="",e.historyStatusIsError=!1,o();try{const s=await c().ListRecallHistory(),a=((t=e.historyDetail)==null?void 0:t.ID)??null;e.historyEntries=s,e.historyCursor=H(e.historyCursor,s),e.historySelected=yt(e.historySelected,s),a===null?w():s.some(r=>r.ID===a)?$(a,!0):w()}catch(s){e.historyError=d(s)}finally{e.historyLoading=!1,o()}}async function we(){const t=R()[0];t&&await $(t.ID)}async function $(t,s=!1){var a;if(!(!Number.isFinite(t)||t<=0)&&!(e.historyDetailLoading&&((a=e.historyDetail)==null?void 0:a.ID)===t)&&!(e.historyDetail&&e.historyDetail.ID===t&&!e.historyDetailError)){e.historyDetailLoading=!0,e.historyDetailError="",s||(e.historyStatus="",e.historyStatusIsError=!1),o();try{const r=await c().GetRecallHistory(t);e.historyDetail=r,e.historyQuoteCursor=v(e.historyQuoteCursor,r.Quotes),e.historyQuoteSelected=ee(e.historyQuoteSelected,r.Quotes)}catch(r){e.historyDetailError=d(r)}finally{e.historyDetailLoading=!1,o()}}}function w(){e.historyDetail=null,e.historyDetailLoading=!1,e.historyDetailError="",e.historyQuoteCursor=0,e.historyQuoteSelected=new Set,o()}function K(t,s){e.overlay={type:"quoteEditor",mode:t,quoteId:(s==null?void 0:s.ID)??null,content:(s==null?void 0:s.Content)??"",busy:!1,status:"",isError:!1,previewOriginal:"",previewRefined:""},o()}function $e(t){const s=Oe(t);s&&K("edit",s)}function Se(t){var a;const s=((a=e.overlay)==null?void 0:a.type)==="quoteInspect"&&e.overlay.context===t?[e.overlay.quote.ID]:C(t).map(r=>r.ID);s.length!==0&&(e.overlay={type:"deleteQuotes",context:t,ids:s,busy:!1,status:"",isError:!1},o())}function Ee(){const t=R().map(s=>s.ID);t.length!==0&&(e.overlay={type:"deleteHistory",ids:t,busy:!1,status:"",isError:!1},o())}async function qe(t){var a,r,i;const s=((a=e.overlay)==null?void 0:a.type)==="quoteInspect"&&e.overlay.context===t?[e.overlay.quote]:C(t);if(s.length!==0){e.overlay={type:"shareQuotes",context:t,ids:s.map(n=>n.ID),path:"",payload:"",showPayload:!1,busy:!0,status:"",isError:!1},o();try{const n=await c().PreviewQuoteExport(s.map(u=>u.ID));if(((r=e.overlay)==null?void 0:r.type)!=="shareQuotes")return;e.overlay.payload=n,e.overlay.busy=!1,e.overlay.status="Share payload ready. Save it to a file and transfer it manually.",e.overlay.isError=!1}catch(n){if(((i=e.overlay)==null?void 0:i.type)!=="shareQuotes")return;e.overlay.busy=!1,e.overlay.status=d(n),e.overlay.isError=!0}o()}}function Qe(){e.overlay={type:"importQuotes",path:"",payload:"",filename:"",showPayload:!1,busy:!1,status:"",isError:!1,result:null},o()}function De(t,s){const a=S(t),r=v(s,a),i=a[r];i&&(t==="quotes"?e.quotesCursor=r:t==="recall"?e.recallCursor=r:e.historyQuoteCursor=r,e.overlay={type:"quoteInspect",context:t,quote:i},o())}async function U(){var s,a;if(((s=e.overlay)==null?void 0:s.type)!=="namePrompt"||e.overlay.busy)return;const t=e.overlay.name.trim();if(!t){e.overlay.status="Please enter a name to continue.",e.overlay.isError=!0,o();return}e.overlay.busy=!0,e.overlay.status="Saving profile…",e.overlay.isError=!1,o();try{const r=await c().SaveUserProfile(t);e.bootstrap&&(e.bootstrap.profile=r,e.bootstrap.greeting=`Hi! ${r.DisplayName}`),e.overlay=null}catch(r){((a=e.overlay)==null?void 0:a.type)==="namePrompt"&&(e.overlay.busy=!1,e.overlay.status=d(r),e.overlay.isError=!0)}o()}async function W(){var s,a;if(((s=e.overlay)==null?void 0:s.type)!=="quoteEditor"||e.overlay.busy)return;const t=e.overlay.content.trim();if(!t){e.overlay.status="Nothing to save.",e.overlay.isError=!0,o();return}e.overlay.busy=!0,e.overlay.status="Refining draft...",e.overlay.isError=!1,o();try{const r=e.overlay.mode==="add"?await c().AddQuote(t):await c().UpdateQuote(e.overlay.quoteId??0,t);e.overlay=null,P(r),await h()}catch(r){((a=e.overlay)==null?void 0:a.type)==="quoteEditor"&&(e.overlay.busy=!1,e.overlay.status=d(r),e.overlay.isError=!0),o()}}async function J(){var s,a,r;if(((s=e.overlay)==null?void 0:s.type)!=="quoteEditor"||e.overlay.busy)return;const t=e.overlay.content.trim();if(!t){e.overlay.status="Nothing to refine.",e.overlay.isError=!0,o();return}e.overlay.busy=!0,e.overlay.status="",o();try{const i=await c().RefineQuoteDraft(t);if(((a=e.overlay)==null?void 0:a.type)!=="quoteEditor")return;e.overlay.busy=!1,e.overlay.previewOriginal=t,e.overlay.previewRefined=i,e.overlay.status="",e.overlay.isError=!1}catch(i){((r=e.overlay)==null?void 0:r.type)==="quoteEditor"&&(e.overlay.busy=!1,e.overlay.status=d(i),e.overlay.isError=!0)}o()}function ke(){var t;((t=e.overlay)==null?void 0:t.type)==="quoteEditor"&&(e.overlay.content=e.overlay.previewRefined,e.overlay.previewOriginal="",e.overlay.previewRefined="",e.overlay.status="Refined draft applied. Review it, then save.",e.overlay.isError=!1,o())}function Ie(){var t;((t=e.overlay)==null?void 0:t.type)==="quoteEditor"&&(e.overlay.previewOriginal="",e.overlay.previewRefined="",e.overlay.status="Refined draft discarded.",e.overlay.isError=!1,o())}async function Le(){var t,s,a,r;if(((t=e.overlay)==null?void 0:t.type)==="deleteHistory"){if(e.overlay.busy)return;e.overlay.busy=!0,e.overlay.status="",o();try{await c().DeleteRecallHistory(e.overlay.ids),ze(e.overlay.ids),e.overlay=null,await I()}catch(i){((s=e.overlay)==null?void 0:s.type)==="deleteHistory"&&(e.overlay.busy=!1,e.overlay.status=d(i),e.overlay.isError=!0),o()}return}if(!(((a=e.overlay)==null?void 0:a.type)!=="deleteQuotes"||e.overlay.busy)){e.overlay.busy=!0,e.overlay.status="",o();try{await c().DeleteQuotes(e.overlay.ids),je(e.overlay.ids),e.overlay=null,await h()}catch(i){((r=e.overlay)==null?void 0:r.type)==="deleteQuotes"&&(e.overlay.busy=!1,e.overlay.status=d(i),e.overlay.isError=!0),o()}}}async function Ce(){var t,s,a;if(!(((t=e.overlay)==null?void 0:t.type)!=="shareQuotes"||e.overlay.busy)){if(y()){e.overlay.path="irecall-share.json",o();return}try{const r=await c().SelectQuoteExportFile();r&&((s=e.overlay)==null?void 0:s.type)==="shareQuotes"&&(e.overlay.path=r,o())}catch(r){((a=e.overlay)==null?void 0:a.type)==="shareQuotes"&&(e.overlay.status=d(r),e.overlay.isError=!0,o())}}}async function Pe(){var s,a,r;if(((s=e.overlay)==null?void 0:s.type)!=="shareQuotes"||e.overlay.busy)return;if(y()){const i=e.overlay.path.trim()||"irecall-share.json";if(!e.overlay.payload.trim()){e.overlay.status="Export payload is not ready yet.",e.overlay.isError=!0,o();return}bt(i,e.overlay.payload),e.overlay.status=`Downloaded ${i}`,e.overlay.isError=!1,o();return}const t=e.overlay.path.trim();if(!t){e.overlay.status="Choose a file path for the export.",e.overlay.isError=!0,o();return}if(!e.overlay.payload.trim()){e.overlay.status="Export payload is not ready yet.",e.overlay.isError=!0,o();return}e.overlay.busy=!0,e.overlay.status="",o();try{await c().ExportQuotesToFile(e.overlay.ids,t),((a=e.overlay)==null?void 0:a.type)==="shareQuotes"&&(e.overlay.busy=!1,e.overlay.status=`Saved share payload to ${t}`,e.overlay.isError=!1,o())}catch(i){((r=e.overlay)==null?void 0:r.type)==="shareQuotes"&&(e.overlay.busy=!1,e.overlay.status=d(i),e.overlay.isError=!0,o())}}async function Re(){var t,s,a;if(!(((t=e.overlay)==null?void 0:t.type)!=="importQuotes"||e.overlay.busy)){if(y()){const r=document.querySelector('[data-bind="import-file"]');r==null||r.click();return}try{const r=await c().SelectQuoteImportFile();r&&((s=e.overlay)==null?void 0:s.type)==="importQuotes"&&(e.overlay.path=r,o())}catch(r){((a=e.overlay)==null?void 0:a.type)==="importQuotes"&&(e.overlay.status=d(r),e.overlay.isError=!0,o())}}}async function xe(){var a,r,i;if(((a=e.overlay)==null?void 0:a.type)!=="importQuotes"||e.overlay.busy)return;const t=e.overlay.path.trim(),s=e.overlay.payload.trim();if(y()){if(!s){e.overlay.status="Choose a file to import.",e.overlay.isError=!0,o();return}}else if(!t){e.overlay.status="Choose a file to import.",e.overlay.isError=!0,o();return}e.overlay.busy=!0,e.overlay.status="",e.overlay.result=null,o();try{const n=y()?await c().ImportQuotesPayload(s):await c().ImportQuotesFromFile(t);if(((r=e.overlay)==null?void 0:r.type)!=="importQuotes")return;e.overlay.busy=!1,e.overlay.result=n,e.overlay.status=`Imported quotes. inserted=${n.Inserted} updated=${n.Updated} duplicates=${n.Duplicates} stale=${n.Stale}`,e.overlay.isError=!1,await h()}catch(n){((i=e.overlay)==null?void 0:i.type)==="importQuotes"&&(e.overlay.busy=!1,e.overlay.status=d(n),e.overlay.isError=!0,o())}}async function L(){if(e.recallBusy)return;const t=e.recallQuestion.trim();if(!t){e.recallError="Enter a recall question first.",o();return}e.recallBusy=!0,e.recallError="",e.recallStatus="",e.recallStatusIsError=!1,e.recallLastQuestion=t,e.recallKeywords=[],e.recallQuotes=[],e.recallResponse="",e.recallCursor=0,e.recallSelected=new Set,o();try{const s=await c().RunRecall(t);e.recallKeywords=s.keywords,e.recallQuotes=s.quotes,e.recallResponse=s.response,e.recallLastQuestion=s.question||t,e.recallCursor=0,e.recallSelected=new Set,e.recallQuestion=""}catch(s){e.recallError=d(s)}finally{e.recallBusy=!1,o()}}async function Me(){const t=e.recallLastQuestion.trim(),s=e.recallResponse.trim();if(!t||!s){e.recallStatus="Run a recall first before saving it as a quote.",e.recallStatusIsError=!0,o();return}try{const a=await c().SaveRecallAsQuote(t,s,e.recallKeywords);P(a),await h(),e.recallStatus="Saved recall as quote.",e.recallStatusIsError=!1,V("Saved the current grounded answer as a quote.")}catch(a){e.recallStatus=d(a),e.recallStatusIsError=!0}o()}async function He(){const t=e.historyDetail;if(t){try{const s=await c().SaveRecallAsQuote(t.Question,t.Response,[]);P(s),await h(),e.historyStatus="Saved history entry as quote.",e.historyStatusIsError=!1,V("Saved the selected activity session as a quote.")}catch(s){e.historyStatus=d(s),e.historyStatusIsError=!0}o()}}async function Te(){if(e.settingsBusy)return;let t;try{t=Z(e.settings)}catch(s){e.settingsStatus=d(s),e.settingsIsError=!0,o();return}e.settingsBusy=!0,e.settingsStatus="",o();try{const s=await c().FetchModels(t);e.settings.models=s,M(e.settings),e.settingsStatus=s.length>0?`Fetched ${s.length} models.`:"No models returned.",e.settingsIsError=!1}catch(s){e.settingsStatus=d(s),e.settingsIsError=!0}finally{e.settingsBusy=!1,o()}}async function z(){var s;if(e.settingsBusy)return;let t;try{t=pt(e.settings)}catch(a){e.settingsStatus=d(a),e.settingsIsError=!0,o();return}e.settingsBusy=!0,e.settingsStatus="",o();try{const a=await c().SaveSettings(t);e.settings=X(a,e.settings.models),k(e.settings.theme),e.bootstrap&&(e.bootstrap.settings=a);const r=((s=e.auth)==null?void 0:s.runtime)==="web"&&e.auth.currentPort>0&&e.auth.currentPort!==a.Web.Port;e.settingsStatus=r?"Saved. Restart the web server to apply the new port.":"Saved.",e.settingsIsError=!1}catch(a){e.settingsStatus=d(a),e.settingsIsError=!0}finally{e.settingsBusy=!1,o()}}function Y(){e.overlay&&e.overlay.type!=="namePrompt"&&("busy"in e.overlay&&e.overlay.busy||(e.overlay=null,o()))}function V(t,s=!1){e.toast={message:t,isError:s},m!==null&&window.clearTimeout(m),m=window.setTimeout(()=>{e.toast=null,m=null,o()},2600)}function S(t){var s;return t==="quotes"?G():t==="recall"?e.recallQuotes:((s=e.historyDetail)==null?void 0:s.Quotes)??[]}function Fe(t,s){var r;const a=S(t);if(t==="quotes")e.quotesCursor=v(s,a);else if(t==="recall")e.recallCursor=v(s,e.recallQuotes);else{const i=((r=e.historyDetail)==null?void 0:r.Quotes)??[];e.historyQuoteCursor=v(s,i)}o()}function Ne(t,s,a){const r=t==="quotes"?e.quotesSelected:t==="recall"?e.recallSelected:e.historyQuoteSelected;a?r.add(s):r.delete(s),o()}function Ae(t){const s=S(t),a=new Set(s.map(r=>r.ID));t==="quotes"?e.quotesSelected=a:t==="recall"?e.recallSelected=a:e.historyQuoteSelected=a,o()}function Be(t){t==="quotes"?e.quotesSelected=new Set:t==="recall"?e.recallSelected=new Set:e.historyQuoteSelected=new Set,o()}function C(t){const s=S(t),a=t==="quotes"?e.quotesCursor:t==="recall"?e.recallCursor:e.historyQuoteCursor,r=v(a,s),i=t==="quotes"?e.quotesSelected:t==="recall"?e.recallSelected:e.historyQuoteSelected,n=s.filter(u=>i.has(u.ID));return n.length>0?n:s[r]?[s[r]]:[]}function Oe(t){var s;return((s=e.overlay)==null?void 0:s.type)==="quoteInspect"&&e.overlay.context===t?e.overlay.quote:C(t)[0]??null}function G(){const t=e.libraryQuery.trim().toLowerCase();return e.quotes.filter(s=>t?[s.Content,s.AuthorName,s.SourceName,...s.Tags].join(" ").toLowerCase().includes(t):!0)}function P(t){e.quotes=E(e.quotes,t),e.recallQuotes=E(e.recallQuotes,t),e.historyDetail&&(e.historyDetail={...e.historyDetail,Quotes:E(e.historyDetail.Quotes,t)}),o()}function je(t){var a;const s=new Set(t);e.quotes=e.quotes.filter(r=>!s.has(r.ID)),e.recallQuotes=e.recallQuotes.filter(r=>!s.has(r.ID)),e.historyDetail&&(e.historyDetail={...e.historyDetail,Quotes:e.historyDetail.Quotes.filter(r=>!s.has(r.ID))}),e.quotesSelected=new Set([...e.quotesSelected].filter(r=>!s.has(r))),e.recallSelected=new Set([...e.recallSelected].filter(r=>!s.has(r))),e.historyQuoteSelected=new Set([...e.historyQuoteSelected].filter(r=>!s.has(r))),e.quotesCursor=v(e.quotesCursor,e.quotes),e.recallCursor=v(e.recallCursor,e.recallQuotes),e.historyQuoteCursor=v(e.historyQuoteCursor,((a=e.historyDetail)==null?void 0:a.Quotes)??[]),o()}function Ke(t){e.historyCursor=H(t,e.historyEntries);const s=e.historyEntries[e.historyCursor];s&&$(s.ID,!0),o()}function Ue(t,s){s?e.historySelected.add(t):e.historySelected.delete(t),o()}function We(){e.historySelected=new Set(e.historyEntries.map(t=>t.ID)),o()}function Je(){e.historySelected=new Set,o()}function R(){const t=e.historyEntries.filter(s=>e.historySelected.has(s.ID));return t.length>0?t:e.historyEntries[e.historyCursor]?[e.historyEntries[e.historyCursor]]:[]}function ze(t){const s=new Set(t);if(e.historyEntries=e.historyEntries.filter(a=>!s.has(a.ID)),e.historySelected=new Set([...e.historySelected].filter(a=>!s.has(a))),e.historyCursor=H(e.historyCursor,e.historyEntries),e.historyDetail&&s.has(e.historyDetail.ID)){w();return}o()}function o(){if(!b)return;const t=Ye();b.innerHTML=Ge(),Ve(t)}function Ye(){const t=document.activeElement;if(!(t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement||t instanceof HTMLSelectElement))return null;const s=t.dataset.bind;return s?{selector:`[data-bind="${s}"]`,selectionStart:t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement?t.selectionStart:null,selectionEnd:t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement?t.selectionEnd:null}:null}function Ve(t){if(!b||!t)return;const s=b.querySelector(t.selector);(s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement||s instanceof HTMLSelectElement)&&(s.focus({preventScroll:!0}),(s instanceof HTMLInputElement||s instanceof HTMLTextAreaElement)&&t.selectionStart!==null&&t.selectionEnd!==null&&s.setSelectionRange(t.selectionStart,t.selectionEnd))}function Ge(){var s,a,r,i,n;if(!e.authChecked)return`
    ...
    <div class="shell">
      <header class="titlebar">
        <div class="brand-lockup">
          <div class="brand-row">
            <div class="brand">${l(((i=e.bootstrap)==null?void 0:i.productName)??"iRecall")}</div>
  ...
  `}function Xe(){var i;const t=!((i=e.auth)!=null&&i.passwordConfigured),s="auth-login";return`
    <div class="shell shell-loading">
  ...
  `}function tt(){const t=G(),s=v(e.quotesCursor,t),a=t.filter(r=>e.quotesSelected.has(r.ID)).length;return`
  ...
  `}function at(){if(!e.historyDetailLoading&&!e.historyDetail&&!e.historyDetailError)return"";const t=e.historyDetail?e.historyEntries.find(r=>{var i;return r.ID===((i=e.historyDetail)==null?void 0:i.ID)})??e.historyDetail:e.historyEntries[e.historyCursor]??null,s=e.historyDetail&&t&&e.historyDetail.ID===t.ID?e.historyDetail:null,a=(s==null?void 0:s.Quotes)??[];return`
    ...
    <div class="history-list">
      ${e.historyEntries.map((t,s)=>{const a=s===e.historyCursor,r=D(t.Response,156);return`
            <article class="quote-card history-card${a?" is-current":""}" data-action="history-set-cursor" data-index="${s}">
              ...
              <div class="quote-content">${l(D(t.Question,132))}</div>
                <div class="quote-meta"><span class="muted">Response preview</span><span>${l(r||"(empty response)")}</span></div>
            </article>
          `}).join("")}
    </div>
  `}function ot(){var i,n;const t=_(e.settings),s=(i=e.bootstrap)==null?void 0:i.paths,a=(n=e.auth)==null?void 0:n.currentPort,r=e.settings.models.length>0&&t.length>0?`
  ...
  `}function x(t,s,a,r,i){return s.length===0?`<div class="empty-state">${t==="quotes"?"No quotes yet. Add one or import a shared payload.":"No reference quotes for this question yet."}</div>`:`
    <div class="quote-list">
      ${s.map((n,u)=>{const re=u===a,f=t!=="quotes",T=!n.IsOwnedByMe&&n.SourceName?`<span class="meta-accent">${l(n.SourceName)}</span>`:`<span>${l(n.AuthorName||"You")}</span>`,oe=i?`
            ...
            <article class="quote-card${re?" is-current":""}${f?" quote-card-minimal":""}" data-action="quote-inspect" data-context="${t}" data-index="${u}">
              <div class="quote-topline">
                ${f?`<div class="quote-topline-meta">
                        ...
                        <span class="quote-version">${l(Q(n.UpdatedAt))}</span>
                      </div>`:`
                      <label class="selection-toggle">
                        <input
                          type="checkbox"
                    ...
                    `}
                <div class="quote-topline-meta">
                  ${f?`<span class="quote-source-inline">${T}</span>`:`<span class="quote-version">${l(Q(n.UpdatedAt))}</span>
                  <span class="quote-badge">${n.IsOwnedByMe?"Owned":"Imported"}</span>`}
                </div>
              </div>
              <div class="quote-content">${l(D(n.Content,t==="quotes"?160:136))}</div>
  ...
  `:'<div class="empty-state">Select a quote to inspect the full note, provenance, and available actions.</div>'}function Q(t){const s=new Date(t);return Number.isNaN(s.getTime())?t:s.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function A(t){return!Number.isFinite(t)||t<=0?"0 B":t<1024?`${Math.round(t)} B`:t<1024*1024?`${(t/1024).toFixed(1)} KB`:`${(t/(1024*1024)).toFixed(1)} MB`}function nt(t){return`
  ...
  `}function lt(t){switch(t.type){case"namePrompt":return`
      ...
      `;case"notice":return""}}function B(t,s){var i;const a=t==="quotes"?e.quotes:t==="recall"?e.recallQuotes:((i=e.historyDetail)==null?void 0:i.Quotes)??[],r=new Set(s);return a.filter(n=>r.has(n.ID))}function ut(t){const s=new Set(t);return e.historyEntries.filter(a=>s.has(a.ID))}function ct(t){return X(t.settings,[])}function X(t,s){var r,i;const a={host:t.Provider.Host,port:String(t.Provider.Port),https:t.Provider.HTTPS,mockLLM:((r=t.Debug)==null?void 0:r.MockLLM)??!1,apiKey:t.Provider.APIKey,modelFilter:"",model:t.Provider.Model,maxResults:String(t.Search.MaxResults),minRelevance:String(t.Search.MinRelevance),theme:t.Theme||"violet",webPort:String(((i=t.Web)==null?void 0:i.Port)??9527),models:s};return M(a),a}function dt(){return{host:"",port:"11434",https:!1,mockLLM:!1,apiKey:"",modelFilter:"",model:"",maxResults:"5",minRelevance:"0",theme:"violet",webPort:"9527",models:[]}}function Z(t){const s=Number.parseInt(t.port.trim(),10);if(!Number.isInteger(s)||s<1||s>65535)throw new Error("Port must be a number between 1 and 65535.");return{Host:t.host.trim(),Port:s,HTTPS:t.https,APIKey:t.apiKey,Model:t.model}}function pt(t){const s=Z(t),a=Number.parseInt(t.maxResults.trim(),10),r=Number.parseInt(t.webPort.trim(),10);if(!Number.isInteger(a)||a<1||a>20)throw new Error("Max ref quotes must be between 1 and 20.");if(!Number.isInteger(r)||r<1||r>65535)throw new Error("Web port must be a number between 1 and 65535.");const i=Number.parseFloat(t.minRelevance.trim());if(Number.isNaN(i))throw new Error("Min relevance must be a decimal number.");if(i<0||i>1)throw new Error("Min relevance must be between 0.0 and 1.0.");return{Provider:s,Search:{MaxResults:a,MinRelevance:i},Debug:{MockLLM:t.mockLLM},Theme:t.theme,Web:{Port:r}}}function _(t){const s=t.modelFilter.trim().toLowerCase();return s?t.models.filter(a=>a.toLowerCase().includes(s)):t.models}function M(t){if(t.models.length===0)return;const s=_(t);s.length!==0&&(s.includes(t.model)||(t.model=s[0]))}function E(t,s){return t.map(a=>a.ID===s.ID?s:a)}function v(t,s){return s.length===0?0:Math.min(Math.max(t,0),s.length-1)}function ee(t,s){const a=new Set(s.map(r=>r.ID));return new Set([...t].filter(r=>a.has(r)))}function H(t,s){return s.length===0?0:Math.min(Math.max(t,0),s.length-1)}function yt(t,s){const a=new Set(s.map(r=>r.ID));return new Set([...t].filter(r=>a.has(r)))}function l(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function p(t){return l(t)}function g(t,s){const a=t.replace(/\s+/g," ").trim();return a.length<=s?a:`${a.slice(0,s-1).trimEnd()}…`}function vt(t){const s=new Date(t);return Number.isNaN(s.getTime())?t:s.toLocaleString()}function ht(t,s){return t.length===0?"":t.length<=s?t.join(" · "):`${t.slice(0,s).join(" · ")} · +${t.length-s} more`}function D(t,s){return g(t,Math.max(8,s))}function y(){var t;return((t=e.auth)==null?void 0:t.runtime)==="web"}function bt(t,s){const a=new Blob([s],{type:"application/json;charset=utf-8"}),r=URL.createObjectURL(a),i=document.createElement("a");i.href=r,i.download=t,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}function d(t){return t instanceof Error?t.message:String(t)}function te(){var s,a,r;const t=[(s=window.go)==null?void 0:s.backend,(a=window.go)==null?void 0:a.app,(r=window.go)==null?void 0:r.main];for(const i of t)if(i!=null&&i.App)return i.App;return null}async function se(t=3e3){const s=Date.now();for(;;){const a=te();if(a)return a;if(Date.now()-s>=t)throw new Error("Wails backend bridge is unavailable.");await new Promise(r=>window.setTimeout(r,25))}}function c(){const t=te();if(!t)throw new Error("Wails backend bridge is unavailable.");return t}const ae=document.querySelector("#app");if(!ae)throw new Error("Missing #app root");le(ae);
